...
/*
bazel run //game_mcts/tournament_server/sandbox_runner:sandbox_cli -- \
  --server=localhost:50052 --target=//game_mcts/cpp/risk:risk_main \
  -- --seed=7 --games=3
*/
//
...
#include "game_mcts/tournament_server/sandbox_runner.grpc.pb.h"

ABSL_FLAG(std::string, server, "localhost:50052",
          "host:port of the sandbox runner");
ABSL_FLAG(std::string, target, "",
          "Bazel target to run in the sandbox, e.g. //game_mcts/cpp:foo "
