#ifndef GAME_MCTS_GAME_MCTS_TOURNAMENT_SERVER_REFEREE_WORKER_POOL_H
#define GAME_MCTS_GAME_MCTS_TOURNAMENT_SERVER_REFEREE_WORKER_POOL_H
...
#endif  // GAME_MCTS_GAME_MCTS_TOURNAMENT_SERVER_REFEREE_WORKER_POOL_H
