#ifndef GAME_MCTS_GAME_MCTS_TOURNAMENT_SERVER_REFEREE_PLAYER_CONNECTION_H
#define GAME_MCTS_GAME_MCTS_TOURNAMENT_SERVER_REFEREE_PLAYER_CONNECTION_H
...
#endif  // GAME_MCTS_GAME_MCTS_TOURNAMENT_SERVER_REFEREE_PLAYER_CONNECTION_H
