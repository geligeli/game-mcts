#ifndef GAME_MCTS_GAME_MCTS_TOURNAMENT_SERVER_REFEREE_MATCHMAKER_H
#define GAME_MCTS_GAME_MCTS_TOURNAMENT_SERVER_REFEREE_MATCHMAKER_H
...
#include "game_mcts/tournament_server/referee/client_handle.h"
#include "game_mcts/tournament_server/referee/game_run.h"
#include "game_mcts/tournament_server/referee/game_session.h"
#include "game_mcts/tournament_server/referee/worker_pool.h"
...
struct MatchmakerConfig {
  ...
  // Forwarded to every game; see GameRunConfig::on_record. This is how the
  // match referee knows a game finished and who won it.
...
#endif  // GAME_MCTS_GAME_MCTS_TOURNAMENT_SERVER_REFEREE_MATCHMAKER_H
