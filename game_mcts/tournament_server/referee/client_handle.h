#ifndef GAME_MCTS_GAME_MCTS_TOURNAMENT_SERVER_REFEREE_CLIENT_HANDLE_H
#define GAME_MCTS_GAME_MCTS_TOURNAMENT_SERVER_REFEREE_CLIENT_HANDLE_H
...
#endif  // GAME_MCTS_GAME_MCTS_TOURNAMENT_SERVER_REFEREE_CLIENT_HANDLE_H
