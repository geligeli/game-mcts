#ifndef GAME_MCTS_GAME_MCTS_TOURNAMENT_SERVER_SERVER_FLEET_WORKER_H
#define GAME_MCTS_GAME_MCTS_TOURNAMENT_SERVER_SERVER_FLEET_WORKER_H
...
#endif  // GAME_MCTS_GAME_MCTS_TOURNAMENT_SERVER_SERVER_FLEET_WORKER_H
