#ifndef GAME_MCTS_GAME_MCTS_ARENA_BENCHGAME_BENCH_GAME_H
#define GAME_MCTS_GAME_MCTS_ARENA_BENCHGAME_BENCH_GAME_H
...
#endif  // GAME_MCTS_GAME_MCTS_ARENA_BENCHGAME_BENCH_GAME_H
