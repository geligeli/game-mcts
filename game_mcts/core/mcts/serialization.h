#ifndef GAME_MCTS_GAME_MCTS_CORE_MCTS_SERIALIZATION_H
#define GAME_MCTS_GAME_MCTS_CORE_MCTS_SERIALIZATION_H
...
#endif  // GAME_MCTS_GAME_MCTS_CORE_MCTS_SERIALIZATION_H
