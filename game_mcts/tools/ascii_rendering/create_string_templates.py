...
docker run \
    ...
    takumi.city/jax-training:latest \
        bash -c \
    'cd /large_nfs/risk-game-ai; bazel run //game_mcts/games/risk/ascii_rendering:create_template_strings -- --width-start 48 --width-end 120 --text-width 3 --output-prefix /large_nfs/risk-game-ai/ascii_rendering/templates/tmpl'
...
docker run \
    ...
    bash -c \
    'cd /large_nfs/risk-game-ai; bazel run //game_mcts/games/risk/ascii_rendering:create_template_strings -- --width-start 48 --width-end 120 --text-width 2 --output-prefix /large_nfs/risk-game-ai/ascii_rendering/templates/tmpl'
'''
